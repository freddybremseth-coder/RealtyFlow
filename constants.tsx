...
import { LayoutDashboard, Users, Map, Image as ImageIcon, FileText, Settings, Mic, Building2, Rocket, Share2, Home, Camera, ClipboardList, Layers } from 'lucide-react';
...
export const BRANDS = [
  { id: 'soleada',      name: 'Soleada.no',          type: 'Agency',      category: 'realestate' },
  { id: 'zeneco',       name: 'Zen Eco Homes',        type: 'Development', category: 'realestate' },
  { id: 'pinosoecolife', name: 'Pinosoecolife.com',    type: 'Eco-Living',  category: 'realestate' },
  { id: 'chatgenius',   name: 'Chatgenius.pro',        type: 'SaaS',        category: 'saas' },
  { id: 'freddy',       name: 'Freddybremseth.com',   type: 'Personal',    category: 'personal' },
  { id: 'donaanna',     name: 'Donaanna.com',          type: 'Gård/Shop',   category: 'agriculture' },
];
...
export const NAVIGATION_ITEMS = [
  ...
  { label: 'Business Hub', icon: <Layers size={20} />, path: '/business' },
